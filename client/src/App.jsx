...
import ForgotPassword from './pages/ForgotPassword_student';
import ForgotPassword_admin from './pages/ForgotPassword_admin'
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/admin-forgot-password" element={<ForgotPassword_admin />} />
